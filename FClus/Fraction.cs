...
namespace FClus
{
    ...
    public class Fraction
    {
        ...
        /// <summary>
        /// longernal function for constructors
        /// </summary>
        ...
        public static Fraction ConvertToFraction(string strValue)
        {
            ...
            long iNumerator = Convert.ToInt64(strValue.Substring(0, (int)i));
            long iDenominator = Convert.ToInt64(strValue.Substring((int)(i + 1)));
        ...
        public static Fraction ConvertToFraction(double dValue)
        {
            try
            {
                ...
                else
                {
                    ...
                    while (strTemp[(int)i] != '.')
                        i++;
                    long iDigitsAfterDecimal = strTemp.Length - i - 1;
